...
public class ManagementPanel extends JPanel {
	...
	public ManagementPanel() {
		...
		lblNewLabel_3.setFont(new Font("함초롬돋움", Font.BOLD, 12));
		...
		lblNewLabel_4.setFont(new Font("함초롬돋움", Font.BOLD, 12));
		...
		lblNewLabel_5.setFont(new Font("함초롬돋움", Font.BOLD, 12));
		...
		num_textField.setFont(new Font("함초롬돋움", Font.BOLD, 12));
		...
		type_textField.setFont(new Font("함초롬돋움", Font.BOLD, 12));
		...
		id_Field.setFont(new Font("함초롬돋움", Font.BOLD, 12));
		...
		name_textField.setFont(new Font("함초롬돋움", Font.BOLD, 12));
		...
		contact_textField.setFont(new Font("함초롬돋움", Font.BOLD, 12));
		...
		RadioButton_man.setFont(new Font("함초롬돋움", Font.PLAIN, 12));
		panel_11.add(RadioButton_man);
		
		JRadioButton RadioButton_woman = new JRadioButton("\uC5EC\uC790");
		RadioButton_woman.setFont(new Font("함초롬돋움", Font.PLAIN, 12));
