...
public class randomTest implements Runnable {
   ...
   private void initialize() {
      ...
      sl_panel.putConstraint(SpringLayout.WEST, panel_2, 0, SpringLayout.EAST, panel_1);
      ...
      lbl_pickName = new JLabel("New label");
      lbl_pickName.setBounds(223, 156, 513, 91);
      panel_2.add(lbl_pickName);
